...
return monsters
        ...
        && (!str || operatorChoice(m.str, str.value, str.operation))
        && (!dex || operatorChoice(m.dex, dex.value, dex.operation))
        && (!con || operatorChoice(m.con, con.value, con.operation))
        && (!int || operatorChoice(m.int, int.value, int.operation))
        && (!wis || operatorChoice(m.wis, wis.value, wis.operation))
        && (!cha || operatorChoice(m.cha, cha.value, cha.operation));
}
